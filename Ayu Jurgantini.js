...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#CC9900").s().p("ApSH5IAAvxISlAAIAAPxg");
	this.shape.setTransform(361.45,50.5);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#660033").s().p("A1oH5IAAvxMArRAAAIAAPxg");
	this.shape_1.setTransform(138.475,50.5);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("Ah8H5IAAvxID5AAIAAPxg");
	this.shape_2.setTransform(289.45,50.5);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#660033").s().p("ApSH5IAAvxISlAAIAAPxg");
	this.shape_3.setTransform(361.45,50.5);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#CCCC00").s().p("A1oH5IAAvxMArRAAAIAAPxg");
	this.shape_4.setTransform(138.475,50.5);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.rf(["#0000FF","#000000"],[0,1],0,0,0,0,0,147.4).s().p("A1oH5IAAvxMArRAAAIAAPxg");
	this.shape_5.setTransform(138.475,50.5);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.rf(["#00FF00","#000000"],[0,1],0,0,0,0,0,78.1).s().p("ApSH5IAAvxISlAAIAAPxg");
	this.shape_6.setTransform(361.45,50.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).to({state:[{t:this.shape_2},{t:this.shape_4},{t:this.shape_3}]},1).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.shape_2}]},15).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	// text
	this.text = new cjs.Text("C", "55px 'Comic Sans MS'", "#0000FF");
	this.text.lineHeight = 79;
	this.text.lineWidth = 49;
	this.text.parent = this;
	this.text.setTransform(342.55,30.3);

	this.text_1 = new cjs.Text("Tombol", "50px 'Comic Sans MS'", "#0000FF");
	this.text_1.lineHeight = 72;
	this.text_1.lineWidth = 179;
	this.text_1.parent = this;
	this.text_1.setTransform(58.05,34.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.text_1,p:{x:58.05,y:34.4,color:"#0000FF",lineWidth:179}},{t:this.text,p:{x:342.55,y:30.3,color:"#0000FF"}}]}).to({state:[{t:this.text_1,p:{x:56.05,y:32.75,color:"#00FF33",lineWidth:185}},{t:this.text,p:{x:340.55,y:29.65,color:"#00CC99"}}]},1).wait(1));

	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#66FFCC").s().p("ApSH5IAAvxISlAAIAAPxg");
	this.shape.setTransform(361.45,50.5);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#CCFF00").s().p("A1oH5IAAvxMArRAAAIAAPxg");
	this.shape_1.setTransform(138.475,50.5);
	...
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFF66").s().p("ApSH5IAAvxISlAAIAAPxg");
	this.shape_3.setTransform(361.45,50.5);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFF00").s().p("A1oH5IAAvxMArRAAAIAAPxg");
	this.shape_4.setTransform(138.475,50.5);
...
if (reversed == null) { reversed = false; }
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#33FFCC").s().p("A1oH5IAAvxMArRAAAIAAPxg");
	this.shape.setTransform(138.475,50.5);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#33FF99").s().p("ApSH5IAAvxISlAAIAAPxg");
	this.shape_1.setTransform(361.45,50.5);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#CCCCCC").s().p("Ah8H5IAAvxID5AAIAAPxg");
	this.shape_2.setTransform(289.45,50.5);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#33FFCC").s().p("ApSH5IAAvxISlAAIAAPxg");
	this.shape_3.setTransform(361.45,50.5);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#33FF99").s().p("A1oH5IAAvxMArRAAAIAAPxg");
	this.shape_4.setTransform(138.475,50.5);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFF66").s().p("Ah8H5IAAvxID5AAIAAPxg");
	this.shape_5.setTransform(289.45,50.5);
...
if (reversed == null) { reversed = false; }
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#66FFFF").s().p("ApSH5IAAvxISlAAIAAPxg");
	this.shape.setTransform(361.45,50.5);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#00FFCC").s().p("A1oH5IAAvxMArRAAAIAAPxg");
	this.shape_1.setTransform(138.475,50.5);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#99CCCC").s().p("Ah8H5IAAvxID5AAIAAPxg");
	this.shape_2.setTransform(289.45,50.5);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FF99FF").s().p("ApSH5IAAvxISlAAIAAPxg");
	this.shape_3.setTransform(361.45,50.5);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#9933FF").s().p("A1oH5IAAvxMArRAAAIAAPxg");
	this.shape_4.setTransform(138.475,50.5);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#996699").s().p("Ah8H5IAAvxID5AAIAAPxg");
	this.shape_5.setTransform(289.45,50.5);
...
// stage content:
(lib.AyuJurgantini = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
